...
import static com.deji.movie.data.local.MovieContract.ContactEntry.COLUMN_ID;
import static com.deji.movie.data.local.MovieContract.ContactEntry.COLUMN_MOVIE_ID;
import static com.deji.movie.data.local.MovieContract.ContactEntry.COLUMN_POSTER_URL;
import static com.deji.movie.data.local.MovieContract.ContactEntry.COLUMN_RATING;
import static com.deji.movie.data.local.MovieContract.ContactEntry.COLUMN_RELEASE_DATE;
import static com.deji.movie.data.local.MovieContract.ContactEntry.COLUMN_SYNOPSIS;
import static com.deji.movie.data.local.MovieContract.ContactEntry.COLUMN_TITLE;
import static com.deji.movie.data.local.MovieContract.ContactEntry.TABLE_NAME;
